...
module bispec
  ...
  use bstool,    only: bispecfunc, bispec_lens_lss_kernel, bispec_lens_lss_init, zinterp
  implicit none

contains


subroutine bispec_lens_init(lmax,zs,k,pk0,fitmodel,pkmodel,zn,zmin,zmaxcut,zspacetype,kn,Omegam,H0,b1d,b2d,b3d)
  implicit none
...
subroutine bispec_lens(l1,l2,l3,b1d,b2d,b3d,fitmodel,Omegam,H0,lmax,zn,bl)
!*  Compute lensing bispectrum analytically
!*
!*  Args
!*    :l1/l2/l3 (int) : multipoles of the bispectrum
!*    :zs[3] (double) : source redshifts
!*    :k[:] (double) : k for the matter power spectrum
...
!*
  ...
  ! bispectrum
  call bispec_lens_lss_kernel(cp,b,l1,l2,l3,bl,fitmodel)
